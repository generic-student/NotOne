...
public class ActivityResultLauncherProvider {
    ...
    /**
     * Provides an ActivityResultLauncher that opens a CreateDocument Activity to chose a uri.
    ...
    /**
     * Provides an ActivityResultLauncher that opens a OpenDocument Activity to chose the uri.
    ...
    /**
     * Provides an ActivityResultLauncher that opens a CreateDocument Activity to chose the uri.
    ...
    /**
     * Provides an ActivityResultLauncher that opens a GetContent Activity to chose the uri.
