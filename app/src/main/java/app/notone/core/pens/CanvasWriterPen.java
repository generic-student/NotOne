...
public class CanvasWriterPen extends CanvasPen {
    ...
    public CanvasWriterPen(CanvasWriter writerReference) {
        ...
        mCurrentStroke = new Stroke(writerReference.getStrokeColor(),
                writerReference.getStrokeWeight());
    }
            ...
            case MotionEvent.ACTION_UP:
                ...
                mCanvasWriterRef.getUndoRedoManager().
                        addAction(new CanvasWriterAction(
                                CanvasWriterAction.Type.WRITE, mCurrentStroke));
                //reset the current stroke
                mCurrentStroke = new Stroke(mCanvasWriterRef.getStrokeColor()
                        , mCanvasWriterRef.getStrokeWeight());
